            ...
            <form class="form-horizontal" method="POST" action="/call-checks" id="new_user">
                ...
                <div class="form-row mb-4">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <input class="form-control resetable" type="text" id="lastname" placeholder="" name="report">
                    </div>
                    <div class="form-group col-md-4 col-sm-12">
                        <label for="role" class="col-form-label">Site</label>
                        <select class="selectpicker show-tick form-control" data-style="btn-primary" data-live-search="true"
                            title="Site" id="role" name="site_id">
